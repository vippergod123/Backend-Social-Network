...
function encodeUpdateAccountTransaction  (account, UpdateNameParams, private_key) {
    return new Promise((resolve, reject) => {     
        var req = "https://komodo.forest.network/tx_search?query=%22account=%27"+account+"%27%22"    
        axios.get(req)
        .then(response => {
...
module.exports.encodeUpdateAccountTransaction = encodeUpdateAccountTransaction
